...
🏥 1. [SEGURADORA] Arquitetura Plaforma de Dados: Score de Risco e Detecção de Fraudes.
...
🏥 2. [SEGURADORA] Arquitetuta Data Lakehouse e Databrics: Análise Preventiva de Sinistros e Telemetria
...
Resumo: Desenho de uma infraestrutura analítica completa para uma empresa credenciadora de cartões de crédito. Soluciona o desafio de transformar dados transacionais brutos em informações auditáveis, tratando regras de negócio complexas como taxas de desconto (MDR)[cite: 4], parcelamentos dinâmicos e antecipações de recebíveis (RAV) influenciadas pela taxa SELIC. O ecossistema garante rastreabilidade total sem necessidade de reengenharia diante de novos sistemas.
